...
This is Perl module B<Plack::Middleware::Acme::AAHTTPHeader>.
...
Plack::Middleware::Acme::AAHTTPHeader installation is straightforward. If your CPAN shell is set up,
you should just be able to do

    % cpan Plack::Middleware::Acme::AAHTTPHeader
...
Plack::Middleware::Acme::AAHTTPHeader documentation is available as in POD. So you can do:

    % perldoc Plack::Middleware::Acme::AAHTTPHeader


=head1 REPOSITORY

Plack::Middleware::Acme::AAHTTPHeader is hosted on github
L<http://github.com/bayashi/Plack-Middleware-Acme-AAHTTPHeader>
